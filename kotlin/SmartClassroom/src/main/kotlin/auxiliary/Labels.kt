...
object Labels {
    ...
    const val USER_CONTROL = "user_control"
    ...
    private val fields : Map<String, TextField> = mapOf(
        NAME to TextField("SmartClassroom"),
        TITLE to TextField(),
        ...
        USER_CONTROL to TextField(
            "Управление\nпользователями",
            "Управление пользователями",
            "Список всех пользователей",
            other = mapOf(
                USER_ADD to "Добавить нового пользователя",
                USER_EDIT to "Именить"
            )
        ),
        USER_ADD to TextField(
            "Добавление пользователя",
            "Добавление пользователя",
            "Введите данные нового пользователя"
        ),
        USER_EDIT to TextField(
            "Изменение пользователя",
            "Изменение пользователя",
            "Введите обновлённые данные пользователя"
        ),
